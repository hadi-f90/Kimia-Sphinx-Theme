...
path_to_webdriver = getcwd()+"\msedgedriver.exe"  # This is the path to the webdriver. Change this to where you put the driver.
...
build_folder_name = "build_rest_preview"

driver = webdriver.Edge(executable_path=path_to_webdriver)  # Change "Chrome" to the right type of browser driver you are using
